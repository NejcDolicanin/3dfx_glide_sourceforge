...
Contact the application Vendor\n",
  ...
  if (sRes == GR_RESOLUTION_NONE ) { /* In a window */
	...
	/* nd Extended */
	static int _w[] = {320,320,400,512,640,640,640,640,800,960,856,512,1024,1280,1600,400,1152,1280,1600,1792,1856,1920,2048,2048,768,960,1064,1144,1400,1280,1280,1360,1440,1600,1680,1680,1792,1920,1920,1920,1960,2096,2304,2560,3840};
  static int _h[] = {200,240,256,384,200,350,400,480,600,720,480,256,768,1024,1200,300,864,960,1024,1344,1392,1440,1536,2048,480,600,600,480,600,720,800,768,900,900,720,1050,768,800,1080,1200,840,900,960,1080,2160};

    if ((sRes <  GR_RESOLUTION_320x200) ||
        (sRes >  GR_RESOLUTION_3840x2160)) /* nd Extended */
