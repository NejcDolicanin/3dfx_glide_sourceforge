...
Contact the application Vendor\n",
  ...
  if (sRes == GR_RESOLUTION_NONE ) { /* In a window */
	...
	/* nd Extended */
	static int _w[] = {320,320,400,512,640,640,640,640,800,960,856,512,1024,1280,1600,400,1152,1280,1600,1792,1856,1920,2048,2048,768,960,1064,1144,1432,1280,1280,1360,1440,1600,1680,1680,1792,1920,1920,1920,1960,2096,2304,2560,3840};
