...
/* Nejc RED TINT*/
#if defined(__MINGW32__) || (defined(__MSC__) )

#define _aligned_malloc(a, b) malloc(a)
#define _aligned_free free

/* nejc removed - Causes Red tint */
...
getRegPath()
{
  ...
  else
  {
    ...
    if ( status > 0 ) {
      static char strval[256]; /* static char strval[256]; */
      strval[0] = '\0';
      /* CM_REGISTRY_HARDWARE for device's key under Enum
	  ...
	  /*retVal = "SYSTEM\\CurrentControlSet\\Services\\Class\\Display\\0000\\glide";*/
	  /* Nejc workaround cus this is very unreliable */
    }
  }
  return retVal;
} /* getRegPath */
...
#define FN_NAME "hwcInitLookupRefresh"
  ...
  case(GR_REFRESH_120Hz):
    refresh_hz = 120;
    break;
 case(GR_REFRESH_144Hz): /* nd Extended */
    refresh_hz = 144;
    break;
  default:
...
#define FN_NAME "hwcResolutionSupported"
  static char *resNames[] = {
	...
	/* nd Extended */
	"GR_RESOLUTION_768x480",
	"GR_RESOLUTION_960x600",
	"GR_RESOLUTION_1064x600",
	"GR_RESOLUTION_1144x480",
	"GR_RESOLUTION_1400x600",
  ...
  "GR_RESOLUTION_2096x900",
  "GR_RESOLUTION_2304x960",
  "GR_RESOLUTION_2560x1080",
