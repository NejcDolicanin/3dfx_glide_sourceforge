...
#define GR_MAX_RESOLUTION   0x23 /* 0x17 */
...
#define kPackMaskB  0x00FFUL
  ...
  struct {                      /* environment data             */
	...
	FxU32  glideResOverride;	/* Glide resolution override nd Extended */	
	FxBool  mesaFxForce16Text;	/* MesaFx 16bit textures override nd Extended */	
	FxBool  mesaFxForce16Pix;	/* MesaFx 16bit pixels override nd Extended */	
