...
#undef ARRAY_LAST
  ...
  /* Glide resolution override nd Extended */	
  _GlideRoot.environment.glideResOverride  = GLIDE_GETENV("FX_GLIDE_OVERRIDE_RESOLUTION", 1L);
  GDBG_INFO(80,"              glideResOverride: %d\n",_GlideRoot.environment.glideResOverride);
  _GlideRoot.environment.mesaFxForce16Text = GETENV("FX_MESA_FORCE_16BPP_TEXTURES") != NULL;
  GDBG_INFO(80,"              mesaFxForce16Text: %d\n",_GlideRoot.environment.mesaFxForce16Text);
  _GlideRoot.environment.mesaFxForce16Pix  = GETENV("FX_MESA_FORCE_16BPP_PIX") != NULL;
